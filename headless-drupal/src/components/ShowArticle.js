...
export const ShowArticle = () =>{
    const {fetchArticle, ArticleList, updateArticle} = useArticle()
        ...
        <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
            ...
            <form class="p-4 md:p-5" onSubmit={handlesubmit}>
                <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <input type="text" onChange={handleonchange} name="title" id="name" value={formdata.title} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" />
                    
                    <label for="body" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Body</label>
<textarea name="body" value={formdata.body} rows="4" onChange={handleonchange} class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
        ...
        {ArticleList && ArticleList.map(current=> (
        <div className="max-w-sm border rounded p-3 m-4">
