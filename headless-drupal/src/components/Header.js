    ...
    return (
        <div className="max-w-7xl m-auto">
           <header className="border-b">
            <div className="flex justify-between flex-wap items-center py-2 mx-2">
                <div className="logo">
                    <img src={Logo} />
                </div>
                <nav>
                    {/* <Link to="/" className="p-3 text-lg hover:bg-gray-100 hover:cursor-pointer rounded">Home</Link> */}
